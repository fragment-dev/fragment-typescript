...
export class Transactions extends APIResource {
   ...
   * ```
   */
  update(transactionRef: string, body: TransactionUpdateParams, options?: RequestOptions): APIPromise<TransactionUpdateResponse> {
   ...
   * ```
   */
  searchAllocations(body: TransactionSearchAllocationsParams, options?: RequestOptions): APIPromise<TransactionSearchAllocationsResponse> {
