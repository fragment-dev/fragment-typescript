...
export const parseLogLevel = (maybeLevel: string | undefined, sourceName: string, client: Fragment): LogLevel | undefined => {
  if (!maybeLevel) {
    return undefined;
  }
...
export function loggerFor(client: Fragment): Logger {
