...
- <code title="get /external-payments/:transactionId">client.externalPayments.<a href="./src/resources/external-payments.ts">retrieve</a>() -> ExternalPaymentSuccess</code>
...
- <code title="get /invoices/:id">client.invoices.<a href="./src/resources/invoices.ts">retrieve</a>() -> InvoiceSuccess</code>
...
- <code title="get /parties/:externalId">client.parties.<a href="./src/resources/parties.ts">retrieve</a>() -> PartySuccess</code>
